...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-secondary-background relative flex w-full flex-1 flex-col transition-[margin] duration-200 ease-linear",
        ...
        "md:peer-data-[variant=floating]:peer-data-[state=expanded]:ml-[--sidebar-width]",
        "md:peer-data-[collapsible=offcanvas]:peer-data-[state=expanded]:ml-[--sidebar-width]",
        className,
      )}
      {...props}
    />
